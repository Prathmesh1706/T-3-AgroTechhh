<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $totalgrain_quintal = $_POST['totalgrain_quintal'];   
        $service_type = "डोअरस्टेप विक्री"; // Assuming this is for warehouse services

        $query = "INSERT INTO doorsteppurchase_booking (user_id, mobile_no, grain_type, totalgrain_quintal, service_type) VALUES ('$user_id', '$mobile_no', '$grain_type', '$totalgrain_quintal', '$service_type')";
        $result = mysqli_query($con, $query);

        if ($result) {
            $message = "डोअरस्टेप विक्री यशस्वीरित्या बुक झाले आहे : चेक माझे ऑर्डर्स";
            $alertClass = "success";
        } else {
            $message = "डोअरस्टेप विक्री बुक करण्यात अयशस्वी : पुन्हा प्रयत्न करा";
            $alertClass = "danger";
        }
    }
?>
...
<form method="POST" action="doorstepbook.php" id="bookingForm">
        ...
        <label for="totalgrain_quintal">एकूण धान्य ( क्विंटल मध्ये )</label>
        <input type="number" class="form-control" id="totalgrain_quintal" name="totalgrain_quintal" required><br><br>
        <input type="submit" value="डोअरस्टेप विक्री बुक करा">
    </form>
